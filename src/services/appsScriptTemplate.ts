...
var HEADERS_BY_SHEET = {
  "1_Lancamentos": ["Id", "Data", "Tipo", "Categoria", "Subcategoria", "Descricao", "Valor", "Conta", "Cartao", "Forma_Pagamento", "Status", "Observacoes", "Veiculo", "Km_Atual", "Litros", "Preco_Litro", "Posto"],
  "4_Abastecimentos": ["Id", "Data", "Veiculo", "Km_Atual", "Km_Percorrido", "Litros", "Preco_Litro", "Valor_Total", "Posto", "Media_KmL", "Observacoes"],
  "5_Contas_Bancarias": ["Id", "Nome", "Banco", "Tipo", "Saldo_Inicial", "Saldo_Atual", "Cor_Hex", "Ativa"],
  "6_Consultas_Médicas": ["Id", "Data", "Hora", "Especialidade", "Medico", "Local", "Valor", "Status", "Observacoes"],
  "7_Receitas_Médicas": ["Id", "Data", "Medicamento", "Dosagem", "Instrucoes", "Medico", "Validade", "Ativa"],
  "8_Infracoes": ["Id", "Data", "Hora", "Veiculo", "Local", "Descricao", "Pontos", "Valor", "Status_Pagamento", "Data_Vencimento"],
  "9_Veiculos": ["Id", "Modelo", "Marca", "Ano", "Placa", "Cor", "Km_Atual", "Combustivel", "Ativo"],
  ...
  "14_Oficina": ["Id", "Data", "Veiculo", "Km_No_Servico", "Descricao_Servico", "Oficina_Mecanica", "Valor_Pecas", "Valor_Mao_Obra", "Valor_Total", "Garantia_Ate", "Observacoes"],
  "15_Manutenções_Agendadas": ["Id", "Veiculo", "Item_Manutencao", "Km_Alvo", "Data_Alvo", "Status", "Custo_Estimado", "Observacoes"],
  "16_Lista_De_Mercado": ["Id", "Item", "Categoria", "Quantidade", "Unidade", "Comprado", "Preco_Estimado"],
  "17_Zonas_De_Risco": ["Id", "Nome_Local", "Bairro_Cidade", "Nivel_Risco", "Tipo_Ocorrencia", "Observacoes"],
  "18_Cartões_De_Crédito": ["Id", "Nome", "Bandeira", "Limite_Total", "Dia_Fechamento", "Dia_Vencimento", "Cor_Hex", "Ativo"],
  "19_Agenda_E_Compromissos": ["Id", "Data", "Hora", "Titulo", "Descricao", "Prioridade", "Concluido"]
};
