...
var HEADERS_BY_SHEET = {
  ...
  "8_Infracoes": ["Id", "Protocolo", "Título", "Veículo", "Placa", "Data", "Descrição", "Valor", "Pontos", "Status", "Localização", "Observação", "Conta"],
  ...
  "14_Oficina": ["Id", "Data", "Descrição", "KM", "Valor_A_PG", "Valor_Pago", "Oficina_Nome", "Comprovante_Url", "Observações", "VeiculoID", "Veiculo", "Status", "Conta"],
  ...
  "28_Historico_Corridas": ["Id", "Data", "Origem", "Destino", "Paradas", "DistanciaKm", "DuracaoMinutos", "TempoEsperaMinutos", "CustoCombustivel", "ValorKm", "ValorTempo", "ValorTotal", "Observacoes", "Veiculo", "Placa", "Motorista", "Passageiro", "CpfPassageiro", "OrigemCoords", "DestinoCoords", "ParadasCoords"],
