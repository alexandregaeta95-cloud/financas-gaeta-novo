    ...
    <div className="space-y-6 pb-20 md:pb-8">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          ...
          className="flex-1 sm:flex-initial sm:min-w-[180px] flex items-center justify-center gap-2 p-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-xl text-xs transition-all shadow-md active:scale-95 cursor-pointer"
        >
